...
const ALL_STORIES = [
  // EXAM HOME / DASHBOARD
  { id: 'UA-01', built: true, epic: 'Exam Dashboard (missing)', type: 'User', role: 'All admins', story: 'When I open Exam Management, I need to see my active exams, review queue count, and next scheduled exam at a glance, so I can prioritize my work without navigating into each exam.', src: 'Inferred from all stakeholder sessions — no home screen is a critical gap', built: false, priority: 'P0' },
  { id: 'UA-02', built: true, epic: 'Exam Dashboard (missing)', type: 'User', role: 'Faculty', story: 'I need to clone a previous exam and modify it for this semester, so I don\'t rebuild from scratch every cycle. 80–85% of exams are incremental changes.', src: 'Akshit Q2 (template-first) + ExamSoft comparison', built: false, priority: 'P0' },

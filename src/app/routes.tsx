...
export const ROUTES: RouteDef[] = [
  ...
  { path: '/products/faas', label: 'FaaS', section: 'products', productId: 'faas', component: v(() => import('../views/products/ProductPage'), 'ProductPage'), needsOnNav: true },
  { path: '/products/course-eval', label: 'Course Eval', section: 'products', productId: 'course-eval', component: v(() => import('../views/products/ProductPage'), 'ProductPage'), needsOnNav: true },
  { path: '/products/skills-checklist', label: 'Skills', section: 'products', productId: 'skills-checklist', component: v(() => import('../views/products/ProductPage'), 'ProductPage'), needsOnNav: true },
  { path: '/products/learning-contracts', label: 'LC', section: 'products', productId: 'learning-contracts', component: v(() => import('../views/products/ProductPage'), 'ProductPage'), needsOnNav: true },

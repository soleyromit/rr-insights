...
export const LAST_PUSH = 'Claude automated push — 2026-03-28 (v5.4.0: Exxatly-NEW-DS built — 20 components, SKILL.md v5, Phase 2 audit)';
export const PUSH_METHOD = 'Direct git push via PAT — zero manual steps';
export const SKILL_VERSION = '5.0';
export const SESSIONS_SYNCED = 51;
export const INSIGHTS_TOTAL = 177;
...
export const SESSIONS_RAW_READ = 34;

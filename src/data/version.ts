...
export const LAST_PUSH = 'Claude automated push — 2026-03-28 (v5.5: Arun tracker v2 Granola-verified, NPS 2025 intelligence, QB architecture tab)';
...
export const INSIGHTS_TOTAL = 195;

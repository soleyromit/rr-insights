...
export const PRODUCTS: ProductMeta[] = [
  {
    ...
    roadmapPhases: [
      { phase: 'Jan 20 MVP', items: ['QB + Assessment Builder + Student UX', 'Faculty review + item analysis', 'AI question gap detection', 'WCAG 2.1 AA target'] },
      { phase: 'Mar 2027 LA', items: ['Offline exam download', 'Canvas LMS integration', 'Agentic assessment building', 'Pilot feedback incorporated'] },
      { phase: 'Sep 2026 Cohere', items: ['Production-ready demo', 'UAT walkthroughs', 'October consultant visits (Oct 5-8)', 'Beta signup QR code'] },
      { phase: 'Jun 2027 GA', items: ['Curriculum mapping (placement context)', 'Accreditation reporting', 'AI remediation live', 'Full ExamSoft parity'] },
    ],
    gapsByDiscipline: {
  ...
  },
  {
    ...
    roadmapPhases: [
      { phase: 'Sep 15 Beta', items: ['5-10 programs onboarded', 'Template builder live', 'Distribution workflow live', 'Single-survey analytics live'] },
      { phase: 'Q4 2026', items: ['Multi-survey analytics (by Term/Faculty/Course)', '103 warm program outreach', 'QR beta signup at Cohere'] },
      { phase: 'GA Jan 2027', items: ['AI narrative synthesis', 'Accreditation-ready export', 'Modular pricing launch'] },
    ],
    gapsByDiscipline: {

...
TARGETS="${@:-src/views/SignalsView.tsx src/views/OverviewView.tsx src/views/PersonaMapView.tsx src/views/CompetitiveView.tsx src/views/RoadmapView.tsx src/views/NarrativeView.tsx src/views/WhiteboardView.tsx src/views/StakeholderView.tsx src/views/PortfolioView.tsx src/views/products/ProductPage.tsx src/components src/index.css}"
